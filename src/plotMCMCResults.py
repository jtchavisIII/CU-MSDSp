...
NOTES 
2020-AUG-02 Eventually I need to include the warm-up periods....Not right now
			But before we publish....

			+ Need to handle the burn in issue for Phase two cralwer vs trace plot
			+ Missing critial piece. Only have $Sapmle len...is burn in an issue
			+ Have users decide if they want to show plots
'''
